...
{
  auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m");
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u", std::move (rs));
...
int TestComparison_4 ()
{
  ...
  auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m4");
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u4", std::move (rs));
...
{
  auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m5");
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u5", std::move (rs));
  if (
      user[0].get_recommendation_by_content ()->get_name () != "TheSilence"
...
{
  auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m6");
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u6", std::move (rs));
...
{
  auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m7");
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u7", std::move (rs));
...
int TestComparison_14 ()
{
  ...
  std::vector<RSUser> user = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u14", std::move (rs));
  ...
  try
    {
      auto rs = RecommenderSystemLoader::create_rs_from_movies_file
          ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m15");
//				"presubmit_18.in_m");
...
//        rs->add_movie("TheyWereExpendable",1967,{1,2,8,5,9});
//        rs->add_movie("Harakiri",1967,{2,6,6,10,5});
      auto rs = RecommenderSystemLoader::create_rs_from_movies_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m16");
      auto users = RSUsersLoader::create_users_from_file ("C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u16", std::move (rs));
//				"presubmit_18.in_m");
      std::cout << "You didn't throw an exception when loading an invalid "
  ...
  try
    {
      ...
      auto rs1 = RecommenderSystemLoader::create_rs_from_movies_file (
           "C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_m");
      std::vector<RSUser> users = RSUsersLoader::create_users_from_file (
           "C:\\Users\\busbib\\CLionProjects\\ex5\\io\\presubmit.in_u", std::move (rs1));
